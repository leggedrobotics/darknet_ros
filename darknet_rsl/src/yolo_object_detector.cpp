...
IplImage* get_ipl_image()
{
 ...
 YoloObjectDetector::YoloObjectDetector(std::string cameraTopicName) : imageTransport_(nodeHandle_), rosBoxes_(numClasses_), rosBoxCounter_(numClasses_, 0), rosBoxColors_(numClasses_)
 {
  cameraTopicName_ = cameraTopicName;
